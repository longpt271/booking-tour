    ...
    <div className="rounded bg-white mb-5">
      ...
      <div className="row">
        <div className="col-md-3 border-right">
          <div className="d-flex flex-column align-items-center text-center pt-5 py-3 py-md-5">
            <img
            ...
            <span className="font-weight-bold">
              {enteredFullName || 'long'}
            </span>
            <span className="text-black-50">{enteredEmail || 'email'}</span>
